...
public enum ErrorCode {
    ...
    USERNAME_INVALID(4403, "Username must be at least 3 characters", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(4404, "Password must be at least 8 characters", HttpStatus.BAD_REQUEST),
